...

{
  ...
  <div className='w-full '>
        <p>Full Name</p>
        <input className='border border-zinc-300 rounded p-2 mt-1 w-full' type='text' onChange={(e)=>setName(e.target.value)} value={name}></input>
      </div>
      :
      null
}
      ...
      <div className='w-full '>
        <p>Email</p>
        <input className='border border-zinc-300 rounded p-2 mt-1 w-full' type='email' onChange={(e)=>setEmail(e.target.value)} value={email}></input>
      </div>
      <div className='w-full '>
        <p>Password</p>
        <input className='border border-zinc-300 rounded p-2 mt-1 w-full' type='password' onChange={(e)=>setPassword(e.target.value)} value={password}></input>
      </div>
