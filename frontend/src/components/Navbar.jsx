...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center text-sm py-4 mb-5 border-b-grey-400'>
    <img onClick = {()=>navigate('/')} src={assets.logo} alt="Logo" className="" />
    ...
    <div className='flex items-center gap-4'>
    {
        ...
        : <button onClick = {()=>navigate('/login')} className='bg-[#5f6FFF] px-8 py-3 text-white rounded-full hover:bg-pink-300 font-light cursor-pointer hidden md:block'>Create Account</button>
    }
